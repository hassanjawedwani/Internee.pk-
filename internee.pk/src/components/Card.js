const Card = ({image, title, description, apply}) => {
  return (
    <div style={{width: 300, backgroundColor: "white", padding: "30px 10px", textAlign: "center", borderRadius: "20px", minHeight: "600px"}}>
      ...
      {apply && <button type="button" style={{backgroundColor: "#43A724", color: "white", padding: 10, borderRadius: "12px", border: "none", fontSize: "16px"}}>Apply Now</button>}
    </div>
  );
}
